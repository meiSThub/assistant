...
<div class="row">
  ...
  <div class="col-lg-2" > <br>
    <ul class="nav nav-pills nav-stacked text-center" role="tablist" style="background-color:#F6F6F6; height:200px; padding:10px" >
      ...
      <li class="active" ><a href="news_publicnum.action">公共号</a></li>
    ...
    <table class="table text-overflow">
     ...
     <div class="col-lg-12">
	    ...
	    <ul class="pager pull-right">
	     <s:if test= "page>1" >
	  		<li><a href="news_publicnum.action?page=${page-1}">上一页</a></li>
		 </s:if> 
		 <s:if test= "newsList.size()>7" >
	  		<li><a href="news_publicnum.action?page=${page+1}">下一页</a></li>
	  	 </s:if>
		</ul>
     </div>
</div>
