  ...
  <div class="row">
    ...
    <div class="col-lg-8">
     ...
     <br>
      <div class="col-lg-4">
        <label  class="bkgd">
        <p> <a href="comment_other.action" class="btn  btn-primary pull-right"  role="button"><strong>我的回复</strong></a> <a href="comment_reply.action" class="btn   pull-right"  role="button"><strong>评论我的</strong></a> </p>
        </label>
      </div>
      ...
      <div class="media col-lg-12">
        <div class="media-body">
          <p>
          	<a href="#">我</a>：在&nbsp;<a href="news_detail.action?id=<s:property value="#comment.news.id" />"><s:property value="#comment.news.title" /></a>&nbsp;中评论：
      ...
      <div class="col-lg-12"> 
	    ...
	    <ul class="pager pull-right">
		 ...
		 <s:if test= "commentList.size()>7" >
	  		<li><a href="comment_other.action?page=${page+1}">下一页</a></li>
	  	 </s:if>
		</ul>
    </div>
  </div>
