...
<div class="navbar-wrapper">
  ...
  href="index.action">&nbsp;首&nbsp;页&nbsp;</A></li>
            <li><a href="news_publicnum.action">&nbsp;总&nbsp;帖&nbsp;</A></li>
            <li class="active"><a href="user_publicnum.action">&nbsp;关&nbsp;注&nbsp;</A></li>
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      <div class="col-lg-12" style="background-color:#F6F6F6; height:40px; padding-top:1px;display: inline-block; ">
        <h4><a href=" user_publicnum.action">关注列表</a>&nbsp;<span style="color:#26aeec"><s:property value="user.name"/></span></h4>
      </div>
      <!--******************人物列表***********************-->
     ...
     <ul class="pager pull-right">
	     <s:if test= "page>1" >
	  		<li><a href="user_publicStartDetail.action?id=${user.id}&page=${page-1}">上一页</a></li>
		 </s:if> 
		 <s:if test= "newsList.size()>7" >
	  		<li><a href="user_publicStartDetail.action?id=${user.id}&page=${page+1}">下一页</a></li>
	  	 </s:if>
		</ul>
    </div>
  </div>
