...
<div class="row">
  ...
  <div class="col-lg-2" > <br>
    <ul class="nav nav-pills nav-stacked text-center" role="tablist" style="background-color:#F6F6F6; height:200px; padding:10px" >
      <li ><a href="news_teacher.action">辅导员</a></li>
      <li ><a href="news_publicnum.action">公共号</a></li>
      <li class="active"><a href="notice_list.action">公告栏</a></li>
    </ul>
  </div>
  <br>
  <div class="col-lg-8"> 
    ...
    <table class="table text-overflow">
      ...
      <s:iterator value= "noticeList" var="notice" >
        <tr>
          <td><div class=" text-overflow width"><a href="notice_detail.action?notice.id=<s:property value="#notice.id" />"><s:property value="#notice.title" /></a></div></td>
          <td><div class=" text-overflow" style="width:80px"><s:property value="#notice.authorName" /></div></td>
          <td><s:date name="#notice.postTime" format="MM-dd" /></td>
        </tr>
		</s:iterator>
      </tbody>
    </table>
     ...
     <div class="col-lg-12">
	    ...
	    <ul class="pager pull-right">
	     <s:if test= "page>1" >
	  		<li><a href="notice_list.action?page=${page-1}">上一页</a></li>
		 </s:if> 
		 <s:if test= "noticeList.size()>7" >
	  		<li><a href="notice_list.action?page=${page+1}">下一页</a></li>
	  	 </s:if>
		</ul>
     </div>
</div>
