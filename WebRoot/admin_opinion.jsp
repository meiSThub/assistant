    ...
    <div class="col-lg-2 bkgd"> <br>
      ...
      <div class="col-lg-12">
        <ul class="nav nav-pills nav-stacked" role="tablist">
          ...
          <li class="active"> <a href="admin_option.action">&nbsp;意见反馈</a> </li>
         </ul>
      </div>
    </div>
    <div class="col-lg-8"> 
      ...
      <s:iterator value="opList">
        <div class="media-body">
          <p><a href="#"><s:property value="authorName"/></a>：
          	 <span class="help-block pull-right"><s:property value="postTime"/></span>
          </p>
      ...
      <!--评论结束-->
      	<div class="col-lg-12"> <br>
      	 ...
      	 <s:if test= "page>1" >
	  		<li><a href="admin_option.action?page=${page-1}">上一页</a></li>
	  	 </s:if> 
		 <s:if test= "opList.size()>7" >
	  		<li><a href="admin_option.action?page=${page+1}">下一页</a></li>
	  	</s:if>
		</ul>
	      <%--   <a class="pull-right"  href="admin_option.action?page=${page-1}" ><span><img src="img/1.png"></span></a>
	        <a class="pull-right" href="admin_option.action?page=${page+1}"> <span> <img src="img/2.png"></span></a> &nbsp; --%>
	    </div>
    </div>
