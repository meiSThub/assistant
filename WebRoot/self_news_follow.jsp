   ...
   <div class="col-lg-2 bkgd"> <br>
      ...
      <div class="col-lg-12">
        <ul class="nav nav-pills nav-stacked" role="tablist">
          ...
          <li  class="active"><a href="news_follow.action"><span class="glyphicon glyphicon-list-alt"></span> &nbsp;关注动态</a></li>
	...
	<div class="col-lg-12">
     ...
     <div class="col-lg-12">
	     ...
	     <s:if test= "page>1" >
	  		<li><a href="news_follow.action?page=${page-1}">上一页</a></li>
		 </s:if> 
		 <s:if test= "newsList.size()>7" >
	  		<li><a href="news_follow.action?page=${page+1}">下一页</a></li>
	  	 </s:if>
		</ul>
		<br>
    </div>
