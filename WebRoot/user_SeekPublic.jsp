  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      <div class="col-lg-12">
        ...
        <div class="col-lg-5" >
          <form class="navbar-form " role="search" action="user_SeekPublic.action?page=${page}" method="post">
      ...
      <div class="media col-lg-12"> <a class="pull-left" href="user_publicStartDetail.action?id=<s:property value="#user.id"/>"><img class="media-object img-circle" width="70px" height="70px"  src="imghead/<s:property value="#user.headUrl"/>"  alt="Generic placeholder image"></a>
        <div class="media-body">
          ...
          <div class="col-lg-3">
            <s:if test="#user.id in followList.{startId}">
          	...
          	<s:else>
          		<s:if test="#session.userId!=null">
          			<a type="button" href="follow_publicAdd.action?follw.startId=<s:property value='#user.id'/>&page=${page}" class="btn btn-default navbar-btn pull-right" >&nbsp;关&nbsp;&nbsp;注&nbsp;</a>
          		</s:if>
          		<s:else>
      ...
      <br>
	     ...
	     <s:if test= "page>1" >
	  		<li><a href="user_publicnum.action?page=${page-1}">上一页</a></li>
		 </s:if> 
		 <s:if test= "userList.size()>7" >
	  		<li><a href="user_publicnum.action?page=${page+1}">下一页</a></li>
	  	 </s:if>
		</ul>
      </div>
