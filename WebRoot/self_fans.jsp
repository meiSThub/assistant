  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <div class="col-lg-4"> <br>
        <label  class="bkgd">
        <p> <a href="follow_fans.action" class="btn  btn-primary pull-right"  role="button"><strong>关注我的</strong></a> <a href="follow_start.action" class="btn   pull-right"  role="button"><strong>我关注的</strong></a> </p>
        </label>
      </div>
      <!--******************人物列表***********************-->
      <s:iterator value= "userList" var="user" >
      <div class="media col-lg-12"> <a class="pull-left" href="user_fansDetail.action?id=<s:property value="#user.id"/>"><img class="media-object img-circle" width="70px" height="70px"  src="imghead/<s:property value="#user.headUrl"/>"  alt="Generic placeholder image"></a>
      ...
      <div class="col-lg-12"> 
        <br>
	     ...
	     <s:if test= "page>1" >
	  		<li><a href="tfollow_fans.action?page=${page-1}">上一页</a></li>
		 </s:if> 
		 <s:if test= "userList.size()>7" >
	  		<li><a href="follow_fans.action?page=${page+1}">下一页</a></li>
	  	 </s:if>
		</ul>
      </div>
    </div>
