    ...
    <div class="col-lg-8"> 
      ...
      <div class="col-lg-2 " style="padding-bottom:5px;" >
	   ...
	   <div class="col-lg-12">
        ...
        <p> <a href="admin_notice_adList.action" class="btn  pull-right"  role="button"><strong>管理员发布</strong></a> <a href="manage_adPublicnum.action" class="btn  pull-right"  role="button"><strong>公共号发布</strong></a> <a href="manage_adTeacher.action" class="btn  btn-primary pull-right"  role="button"><strong>导员发布</strong></a></p>
        </label>
      </div>
	  <div class="col-lg-12"> <br>
       ...
       <div class="col-lg-12">
	    ...
	    <ul class="pager pull-right">
	     <s:if test= "page>1" >
	  		<li><a href="manage_teacher.action?page=${page-1}">上一页</a></li>
		 </s:if> 
		 <s:if test= "newsList.size()>7" >
	  		<li><a href="manage_teacher.action?page=${page+1}">下一页</a></li>
	  	 </s:if>
		</ul>
     </div>
      </div>
